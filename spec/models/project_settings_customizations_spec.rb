...
# Unit tests for Passbase::ProjectSettingsCustomizations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Passbase::ProjectSettingsCustomizations do
  let(:instance) { Passbase::ProjectSettingsCustomizations.new }

  describe 'test an instance of ProjectSettingsCustomizations' do
    it 'should create an instance of ProjectSettingsCustomizations' do
      expect(instance).to be_instance_of(Passbase::ProjectSettingsCustomizations)
    end
  end
