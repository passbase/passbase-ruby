...
# Unit tests for Passbase::IdentityResource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Passbase::IdentityResource do
  let(:instance) { Passbase::IdentityResource.new }

  describe 'test an instance of IdentityResource' do
    it 'should create an instance of IdentityResource' do
      expect(instance).to be_instance_of(Passbase::IdentityResource)
    end
  end
  describe 'test attribute "datapoints"' do
    it 'should work' do
