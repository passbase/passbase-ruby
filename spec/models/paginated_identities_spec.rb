...
# Unit tests for Passbase::PaginatedIdentities
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Passbase::PaginatedIdentities do
  let(:instance) { Passbase::PaginatedIdentities.new }

  describe 'test an instance of PaginatedIdentities' do
    it 'should create an instance of PaginatedIdentities' do
      expect(instance).to be_instance_of(Passbase::PaginatedIdentities)
    end
  end
