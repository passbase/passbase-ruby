...
# Unit tests for Passbase::Identity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Passbase::Identity do
  let(:instance) { Passbase::Identity.new }

  describe 'test an instance of Identity' do
    it 'should create an instance of Identity' do
      expect(instance).to be_instance_of(Passbase::Identity)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["created", "processing", "pending", "approved", "declined"])
