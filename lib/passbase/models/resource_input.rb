...
module Passbase
  class ResourceInput
    ...
    attr_accessor :resource_raw_data
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Passbase::ResourceInput` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Passbase::ResourceInput`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'resource_data')
        self.resource_data = attributes[:'resource_data']
      end

      if attributes.key?(:'resource_raw_data')
        self.resource_raw_data = attributes[:'resource_raw_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          resource_data == o.resource_data &&
          resource_raw_data == o.resource_raw_data
    end
    ...
    def hash
      [type, country, resource_files, resource_data, resource_raw_data].hash
    end
