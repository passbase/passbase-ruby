...
module Passbase
  class User
    ...
    def self.openapi_types
      {
        :'email' => :'String',
        :'identity_access_token' => :'String',
        :'required_steps' => :'Array<ProjectSettingsVerificationSteps>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Passbase::User` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Passbase::User`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'identity_access_token')
        self.identity_access_token = attributes[:'identity_access_token']
      end

      if attributes.key?(:'required_steps')
        if (value = attributes[:'required_steps']).is_a?(Array)
          self.required_steps = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          email == o.email &&
          identity_access_token == o.identity_access_token &&
    ...
    def hash
      [email, identity_access_token, required_steps].hash
    end
