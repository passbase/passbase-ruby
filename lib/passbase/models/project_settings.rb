...
module Passbase
  class ProjectSettings
    ...
    attr_accessor :verification_steps
    ...
    def self.openapi_types
      {
        ...
        :'verification_steps' => :'Array<ProjectSettingsVerificationSteps>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Passbase::ProjectSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Passbase::ProjectSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customizations')
        self.customizations = attributes[:'customizations']
      end

      if attributes.key?(:'verification_steps')
        if (value = attributes[:'verification_steps']).is_a?(Array)
          self.verification_steps = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          verification_steps == o.verification_steps
    end
    ...
    def hash
      [id, slug, environment, organization, customizations, verification_steps].hash
    end
